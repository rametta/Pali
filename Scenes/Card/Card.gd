...
#		if area.get_instance_id() == Global.card_in_dropzone(get_instance_id()):
...
#		if Global.is_dropzone_free(area.get_instance_id()):
#			print("dropping card into this dz")
#
#			var old_dz_id = Global.card_in_dropzone(get_instance_id())
#			if old_dz_id:
#				print("freeing card from old dz")
#				Global.set_dropzone(old_dz_id, null)
#
#			var tween = get_tree().create_tween()
#			tween.tween_property(self, "global_position", area.global_position, 0.15)
#			tween.tween_callback(
#				func():
#					Global.set_dropzone(area.get_instance_id(), get_instance_id())
#			)
#			return
#		else:
...
#	var dz_id = Global.card_in_dropzone(get_instance_id())
#	if dz_id:
#		print("freeing card from any dz")
#		Global.set_dropzone(dz_id, null)
#		return
#
